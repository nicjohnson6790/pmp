...
import { AuthClient, CardsClient, PalettesClient, TilesClient, WeatherForecastClient } from './generated/api-client'
...
export const tilesApi = new TilesClient('', authorizedHttp)
